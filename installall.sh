...
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Tomi292/Uncursus/new/procursus.sh)"
...
echo "URIs: https://artikushg.github.io/" >> /etc/apt/sources.list.d/odyssey.sources
...
unzip /User/Documents/uncursus/Patches.zip -d /User/Documents/uncursus/Patches
...
dpkg -i --force-all /User/Documents/uncursus/Patches/*.deb
